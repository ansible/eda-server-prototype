import { Card, CardBody, Flex, FlexItem, PageSection, Stack, StackItem, Title } from '@patternfly/react-core';
          ...
          <Flex direction={{ default: 'column' }} flex={{ default: 'flex_1' }}>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{rulebook?.name}</StackItem>
              </Stack>
            </FlexItem>
            <FlexItem>
              <Stack>
                <StackItem>
                  <Title headingLevel="h3">{intl.formatMessage(sharedMessages.fire_count)}</Title>
                </StackItem>
                <StackItem>{rulebook?.fire_count}</StackItem>
              </Stack>
            </FlexItem>
          </Flex>
          <Flex direction={{ default: 'column' }} flex={{ default: 'flex_1' }}>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{rulebook?.description}</StackItem>
              </Stack>
            </FlexItem>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{rulebook?.created_at}</StackItem>
              </Stack>
            </FlexItem>
          </Flex>
          <Flex direction={{ default: 'column' }} flex={{ default: 'flex_1' }}>
            <FlexItem>
              <Stack>
                <StackItem>
                  <Title headingLevel="h3">{intl.formatMessage(sharedMessages.number_of_rulesets)}</Title>
                </StackItem>
                <StackItem>{rulebook?.ruleset_count}</StackItem>
              </Stack>
            </FlexItem>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{rulebook?.last_modified}</StackItem>
              </Stack>
            </FlexItem>
          </Flex>
        </Flex>
  ...
  return (
    <PageSection page-type={'ruleset-details'} id={'ruleset-details'}>
      ...
      <Stack>
        <StackItem>
          <Card>
            <CardBody>{renderFlexRulebookDetails(rulebook)}</CardBody>
          </Card>
        </StackItem>
      </Stack>
    </PageSection>
