          ...
          <Flex direction={{ default: 'column' }} flex={{ default: 'flex_1' }}>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{inventory?.name}</StackItem>
              </Stack>
            </FlexItem>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{inventory?.created_at}</StackItem>
              </Stack>
            </FlexItem>
          </Flex>
          <Flex direction={{ default: 'column' }} flex={{ default: 'flex_1' }}>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{inventory?.description}</StackItem>
              </Stack>
            </FlexItem>
            <FlexItem>
              <Stack>
                ...
                <StackItem>{inventory?.modified_at}</StackItem>
              </Stack>
            </FlexItem>
          </Flex>
          <Flex direction={{ default: 'column' }} flex={{ default: 'flex_1' }}>
            <FlexItem>
              <Stack>
                <StackItem>
                  <Title headingLevel="h3">{intl.formatMessage(sharedMessages.source_of_inventory)}</Title>
                </StackItem>
                <StackItem>{inventory?.source}</StackItem>
              </Stack>
            </FlexItem>
          </Flex>
        </Flex>
              ...
              <GridItem span={2}>
                <ToggleGroup isCompact aria-label="JsonYaml">
                  <ToggleGroupItem
                    text="YAML"
                    buttonId="yaml"
                    isSelected={invFormat === 'yaml'}
                    onChange={handleToggleFormat}
                  />
                  <ToggleGroupItem
                    text="JSON"
                    buttonId="json"
                    isSelected={invFormat === 'json'}
                    onChange={handleToggleFormat}
                  />
                </ToggleGroup>
              </GridItem>
  ...
  return (
    <PageSection page-type={'inventory-details'} id={'inventory-details'}>
      ...
      <Stack>
        <StackItem>
          <Card>
            <CardBody>{renderFlexInventoryDetails(inventory)}</CardBody>
          </Card>
        </StackItem>
      </Stack>
    </PageSection>
